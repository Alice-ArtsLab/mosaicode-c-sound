...
class LowShelving(BlockModel):
    ...
    def __init__(self):
        ...
        self.help = "Low Shelving"
        self.label = "LowShelving"
        ...
        self.codes["declaration"] = "mscsound_lowshelving_t *$label$_$id$;\n"

        self.codes["function"] = ""
        self.codes["execution"] = "$label$_$id$->process(&$label$_$id$);\n"
        self.codes["setup"] = \
"""
$label$_$id$ = mscsound_create_lowshelving(FRAMES_PER_BUFFER);
